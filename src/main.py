...
class faTesterMain(runcore.faTesterRun):
    ...
    def callbackShowRevisionHistory( self, event ):
        msgText = ((uilang.kMsgLanguageContentDict['revisionHistory_v1_0_0'][0]) +
                   ...
                   (uilang.kMsgLanguageContentDict['revisionHistory_v2_0_0'][0]) +
                   (uilang.kMsgLanguageContentDict['revisionHistory_v3_0_0'][0]))
...
if __name__ == '__main__':
    ...
    g_main_win.SetTitle(u"MCU FA Test Suite v3.0.0")
    g_main_win.Show()
