...
class Ui_faTesterWin(object):
    def setupUi(self, faTesterWin):
        ...
        self.resFrame.setGeometry(QtCore.QRect(260, 10, 721, 361))
        ...
        self.progressBar_action.setGeometry(QtCore.QRect(10, 330, 701, 20))
        ...
        self.textEdit_printWin.setGeometry(QtCore.QRect(540, 10, 171, 311))
        self.textEdit_printWin.setObjectName("textEdit_printWin")
        self.groupBox_testResult = QtWidgets.QGroupBox(self.resFrame)
        self.groupBox_testResult.setGeometry(QtCore.QRect(10, 10, 521, 311))
